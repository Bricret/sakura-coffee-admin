                ...
                tables.map((item : any) => (
                    ...
                    >
                        ...
                        <td className={`px-4 py-2 text-black  first:rounded-l-2xl last:rounded-r-2xl text-center cursor-default`}>
                            <p className={`relative max-w-fit inline-flex items-center text-base box-border whitespace-nowrap px-2    rounded-full capitalize" ${ item.estado === 'libre' ? "bg-[#d1f4e0] text-[#43d380]" : "bg-[#fdd0df] text-[#f31260]" }`}>
                                { item.estado }
                            </p>
                        </td>
                        {
